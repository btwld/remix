...
class _Section extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => PlaygroundCard(
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
...
class _Matrix<R, C> extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SingleChildScrollView(
    ...
    child: Table(
      ...
      border: TableBorder.all(color: PlaygroundTokens.border.resolve(context)),
      columnWidths: {
  ...
  Widget build(BuildContext context) => DefaultGalleryPage(
    ...
    sections: [
      _Section(
        ...
        child: _Matrix(
          rows: PlaygroundButtonVariant.values,
          columns: PlaygroundButtonSize.values,
          rowLabel: _enumLabel,
          columnLabel: _enumLabel,
          cell: (variant, size) => PlaygroundButton(
            variant: variant,
            size: size,
      ...
      _Section(
        ...
        child: _Matrix(
          rows: PlaygroundIconButtonVariant.values,
          columns: PlaygroundIconButtonSize.values,
          rowLabel: _enumLabel,
          columnLabel: _enumLabel,
          cell: (variant, size) => PlaygroundIconButton(
            variant: variant,
            size: size,
      ...
      _Section(
        ...
        child: _Matrix(
          rows: PlaygroundToggleVariant.values,
          columns: PlaygroundToggleSize.values,
          rowLabel: _enumLabel,
          columnLabel: _enumLabel,
          cell: (variant, size) => PlaygroundToggle(
            variant: variant,
            size: size,
            selected: _selected,
      ...
      _Section(
        ...
        child: Wrap(
          ...
          runSpacing: 12,
          children: [
            const PlaygroundButton(label: 'Disabled', enabled: false),
            PlaygroundButton(label: 'Saving', loading: true, onPressed: () {}),
  ...
  Widget build(BuildContext context) => DefaultGalleryPage(
    ...
    sections: [
      ...
      const _Section(
        ...
        child: SizedBox(
          width: 360,
          child: PlaygroundTextArea(hintText: 'Add a note…'),
        ),
      ),
      _Section(
        ...
        child: Align(
          ...
          child: PlaygroundSegmentedControl<String>(
      ...
      _Section(
        ...
        child: _Matrix(
          rows: PlaygroundToggleGroupVariant.values,
          columns: PlaygroundToggleGroupSize.values,
          rowLabel: _enumLabel,
          columnLabel: _enumLabel,
          cellWidth: 230,
          cell: (variant, size) => PlaygroundToggleGroup<String>(
            variant: variant,
            size: size,
          ...
          child: Wrap(
            ...
            children: [
              for (final (value, label) in const [
                ...
                PlaygroundCheckboxGroupItem<String>(value: value, label: label),
            ],
          ),
        ),
      ),
      _Section(
        ...
        child: RemixRadioGroup<int>(
          ...
          child: const Wrap(
            spacing: 20,
            children: [
              PlaygroundRadio<int>(value: 1, semanticLabel: 'First option'),
              PlaygroundRadio<int>(value: 2, semanticLabel: 'Second option'),
            ],
          ),
        ),
      ),
      ...
      const _Section(
        ...
        child: Wrap(
          ...
          children: [
            ...
            PlaygroundCheckbox(selected: true, label: 'Labelled'),
            PlaygroundSwitch(
              selected: false,
              enabled: false,
    ...
    sections: [
      const _Section(
        ...
        child: Wrap(
          ...
          crossAxisAlignment: WrapCrossAlignment.center,
          children: [
            PlaygroundAvatar(label: 'RF'),
            PlaygroundAvatar(icon: RemixIcons.person),
          ],
        ),
      ),
      _Section(
        ...
        child: Wrap(
          ...
          runSpacing: 12,
          children: [
            for (final variant in PlaygroundBadgeVariant.values)
              PlaygroundBadge(variant: variant, label: _enumLabel(variant)),
          ],
        ),
      ),
      const _Section(
        ...
        child: SizedBox(
          width: 240,
          child: PlaygroundCard(child: _Text('Card content')),
        ),
      ),
      _Section(
        label: 'Callout',
        ...
        child: Wrap(
          ...
          runSpacing: 12,
          children: [
            for (final variant in PlaygroundCalloutVariant.values)
              SizedBox(
                width: 280,
                child: PlaygroundCallout(
                  variant: variant,
                  icon: variant == PlaygroundCalloutVariant.destructive
        ...
        child: Column(
          ...
          children: [
            ...
            PlaygroundSkeleton(
              ...
              child: const PlaygroundAvatar(label: 'RF'),
            ),
      ...
      _Section(
        ...
        child: Row(
          children: [
            ...
            if (_spinnersRunning)
              const PlaygroundSpinner(semanticsLabel: 'Loading example')
            else
      ...
      const _Section(
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              height: 48,
              child: PlaygroundDivider(orientation: Axis.vertical),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) => DefaultGalleryPage(
    ...
    sections: [
      _Section(
        ...
        child: Align(
          alignment: Alignment.centerLeft,
          child: PlaygroundButton.secondary(
            label: 'Open',
            onPressed: () => showRemixDialog<void>(
              context: context,
              barrierLabel: 'Dismiss',
              builder: (dialogContext) => PlaygroundDialog(
                ...
                child: const Padding(
                  ...
                  child: PlaygroundTextField(hintText: 'teammate@example.com'),
                ),
              ),
            ),
          ),
      ...
      _Section(
        ...
        child: Align(
          ...
          child: SizedBox(
            width: 280,
            height: 320,
            child: PlaygroundSidebar<String>(
      ...
      _Section(
        ...
        child: Wrap(
          ...
          children: [
            ...
            const PlaygroundLink(label: 'Disabled'),
            PlaygroundLink(
              label: 'Documentation',
...
class _OverlayTrigger extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => PlaygroundBadge.outline(label: label);
}
...
class _Code extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
    decoration: BoxDecoration(
      color: PlaygroundTokens.muted.resolve(context),
...
class _Keycap extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
    decoration: BoxDecoration(
      ...
      border: Border.all(color: PlaygroundTokens.border.resolve(context)),
