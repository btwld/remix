...
abstract interface class PlaygroundDashboardDemoKit {
...
class PlaygroundDashboardDemoContent extends StatefulWidget {
  const PlaygroundDashboardDemoContent({
    super.key,
    required this.page,
  ...
  final PlaygroundDashboardDemoKit kit;
  final ValueChanged<PlaygroundDashboardDemoPage> onSelected;
  final PlaygroundDashboardSampleData data;

  @override
  State<PlaygroundDashboardDemoContent> createState() =>
      _PlaygroundDashboardDemoContentState();
}

class _PlaygroundDashboardDemoContentState
    extends State<PlaygroundDashboardDemoContent> {
  ...
  PlaygroundDashboardDemoKit get kit => widget.kit;

  @override
  Widget build(BuildContext context) => PlaygroundDashboardDemoPageFrame(
...
String _description(PlaygroundDashboardDemoPage page) => switch (page) {
