...
export const docsConfig = defineDocsConfig({
  ...
  site: {
    ...
    url: process.env.NEXT_PUBLIC_SITE_URL ?? 'https://btwld.github.io',
    docsPath: '/',
  },
  project: {
    ...
    repository: { url: 'https://github.com/btwld/remix', branch: process.env.DOCS_SOURCE_REF ?? 'main', contentPath: 'docs' },
  },
  socialLinks: [
    { label: 'Component catalog', url: sitePath('/catalog/'), placement: 'menu' },
    { label: 'GitHub', url: 'https://github.com/btwld/remix', placement: 'menu' },
