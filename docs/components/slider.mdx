...
<Info>
  See the [fortalSliderStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/slider.dart) for all available options.
</Info>
