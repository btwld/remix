...
<Info>
  See the [fortalSliderStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/slider.dart) for all available options.
</Info>
