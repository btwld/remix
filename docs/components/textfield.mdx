    ...
    return Column(
      ...
      children: [
        RemixTextField(
          ...
          style: fortalTextFieldStyler(variant: FortalTextFieldVariant.surface),
        ),
        RemixTextField(
          controller: controller,
          label: 'Soft',
          hintText: 'Accent soft field',
          style: fortalTextFieldStyler(variant: FortalTextFieldVariant.soft),
        ),
      ],
    );
  }
...
#### `cursorOffset(Offset value)`

Sets cursor paint offset.
