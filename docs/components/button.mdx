...
<Info>
  See the [fortalButtonStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/button.dart) for all available options.
</Info>
...
See the [alignment API migration table](/components/dialog#alignment-api-migration)
for source-breaking type replacements.
