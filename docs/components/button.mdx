...
class ButtonExample extends StatelessWidget {
  ...
  RemixButtonStyle get destructiveStyle {
    return RemixButtonStyle()
        ...
        .onFocused(
          RemixButtonStyle().backgroundColor(const Color(0xFF732D2D)),
        );
  }
  ...
  RemixButtonStyle get successStyle {
    return destructiveStyle
        ...
        .onHovered(
          RemixButtonStyle().backgroundColor(const Color(0xFF357857)),
        )
        .onFocused(
          RemixButtonStyle().backgroundColor(const Color(0xFF357857)),
        );
    ...
    return Column(
      ...
      children: [
        ...
        RemixButton(
          label: 'Solid Button',
          onPressed: () {},
          style: fortalButtonStyle(variant: FortalButtonVariant.solid),
        ),
        // Soft variant - Medium emphasis, secondary actions
        RemixButton(
          label: 'Soft Button',
          onPressed: () {},
          style: fortalButtonStyle(variant: FortalButtonVariant.soft),
        ),
        // Surface variant - Subtle emphasis with border
        RemixButton(
          label: 'Surface Button',
          onPressed: () {},
          style: fortalButtonStyle(variant: FortalButtonVariant.surface),
        ),
        // Outline variant - Low emphasis, tertiary actions
        RemixButton(
          label: 'Outline Button',
          onPressed: () {},
          style: fortalButtonStyle(variant: FortalButtonVariant.outline),
        ),
...
const RemixButton({
  ...
  StyleSpec<RemixButtonSpec>? styleSpec,
})
```
</CodeGroup>
...
#### `styleSpec` → `StyleSpec<RemixButtonSpec>?`
...
Sets icon placement relative to the label.
