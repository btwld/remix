    ...
    return Column(
      ...
      children: [
        ...
        RemixButton(
          label: 'Solid Button',
          onPressed: () {},
          style: fortalButtonStyler(variant: FortalButtonVariant.solid),
        ),
        // Soft variant - Medium emphasis, secondary actions
        RemixButton(
          label: 'Soft Button',
          onPressed: () {},
          style: fortalButtonStyler(variant: FortalButtonVariant.soft),
        ),
        // Surface variant - Subtle emphasis with border
        RemixButton(
          label: 'Surface Button',
          onPressed: () {},
          style: fortalButtonStyler(variant: FortalButtonVariant.surface),
        ),
        // Outline variant - Low emphasis, tertiary actions
        RemixButton(
          label: 'Outline Button',
          onPressed: () {},
          style: fortalButtonStyler(variant: FortalButtonVariant.outline),
        ),
