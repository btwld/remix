...
<Info>
  See the [fortalToggleGroupStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/toggle_group.dart) for all available options.
</Info>
