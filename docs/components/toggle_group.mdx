...
<Info>
  See the [fortalToggleGroupStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/toggle_group.dart) for all available options.
</Info>
