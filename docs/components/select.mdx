...
class _FortalSelectExampleState extends State<FortalSelectExample> {
  ...
  List<RemixSelectItem<String>> get _items => const [
    ...
    return Column(
      ...
      children: [
        RemixSelect(
          ...
          style: fortalSelectStyler(variant: FortalSelectVariant.surface),
        ),
        RemixSelect(
          ...
          style: fortalSelectStyler(variant: FortalSelectVariant.soft),
        ),
        RemixSelect(
          ...
          style: fortalSelectStyler(variant: FortalSelectVariant.ghost),
        ),
      ],
    );
  }
