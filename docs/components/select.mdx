...
class _FortalSelectExampleState extends State<FortalSelectExample> {
  ...
  List<RemixSelectItem<String>> _items(FortalSelectVariant variant) {
    final itemStyle = fortalSelectMenuItemStyler(variant: variant);

    return [
      RemixSelectItem(value: 'opt1', label: 'Option 1', style: itemStyle),
      RemixSelectItem(value: 'opt2', label: 'Option 2', style: itemStyle),
    ];
  }
    ...
    return Column(
      ...
      children: [
        FortalSelect(
          ...
          items: _items(FortalSelectVariant.surface),
        ...
        FortalSelect(
          ...
          items: _items(FortalSelectVariant.soft),
          selectedValue: _soft,
        ...
        FortalSelect(
          ...
          items: _items(FortalSelectVariant.ghost),
...
<Info>
  `FortalSelect` applies the trigger and menu container styles. Use `fortalSelectMenuItemStyler` on `RemixSelectItem` rows to match item styling.
