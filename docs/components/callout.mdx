    ...
    return Column(
      ...
      children: [
        RemixCallout(
          ...
          icon: Icons.info_outline,
          style: fortalCalloutStyler(variant: FortalCalloutVariant.surface),
        ),
        RemixCallout(
          text: 'Soft callout',
          icon: Icons.lightbulb_outline,
          style: fortalCalloutStyler(variant: FortalCalloutVariant.soft),
        ),
        RemixCallout(
          text: 'Outline callout',
          icon: Icons.border_outer,
          style: fortalCalloutStyler(variant: FortalCalloutVariant.outline),
        ),
      ],
    );
  }
