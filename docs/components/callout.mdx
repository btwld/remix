...
<Info>
  See the [fortalCalloutStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/callout.dart) for all available options.
</Info>
