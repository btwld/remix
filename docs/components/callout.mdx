    ...
    return Column(
      ...
      children: [
        RemixCallout(
          ...
          icon: Icons.info,
          style: fortalCalloutStyle(variant: FortalCalloutVariant.surface),
        ),
        RemixCallout(
          text: 'Success callout',
          icon: Icons.check_circle,
          style: fortalCalloutStyle(variant: FortalCalloutVariant.soft),
        ),
        RemixCallout(
          text: 'Warning callout',
          icon: Icons.warning,
          style: fortalCalloutStyle(variant: FortalCalloutVariant.outline),
        ),
      ],
    );
  }
...
const RemixCallout({
  ...
  StyleSpec<RemixCalloutSpec>? styleSpec,
})
```
</CodeGroup>
...
#### `styleSpec` → `StyleSpec<RemixCalloutSpec>?`
