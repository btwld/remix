...
<Info>
  See the [fortalTooltipStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/tooltip.dart) for all available options.
</Info>
