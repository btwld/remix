...
<Info>
  See the [fortalTooltipStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/tooltip.dart) for all available options.
</Info>
