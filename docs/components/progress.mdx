...
<Info>
  See the [fortalProgressStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/progress.dart) for all available options.
</Info>
