...
<Info>
  See the [fortalProgressStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/progress.dart) for all available options.
</Info>
