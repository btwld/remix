...
<Info>
  See the [fortalSwitchStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/switch.dart) for all available options.
</Info>
