...
<Info>
  See the [fortalBadgeStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/badge.dart) for all available options.
</Info>
