...
class BadgeExample extends StatelessWidget {
  ...
  RemixBadgeStyler get styleIcon {
    return RemixBadgeStyler()
        ...
        .wrap(WidgetModifierConfig.iconTheme(color: Colors.white, size: 15));
  }
}
```
</CodeGroup>
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        RemixBadge(
          label: 'Solid',
          style: fortalBadgeStyler(variant: FortalBadgeVariant.solid),
        ),
        RemixBadge(
          label: 'Soft',
          style: fortalBadgeStyler(variant: FortalBadgeVariant.soft),
        ),
        RemixBadge(
          label: 'Surface',
          style: fortalBadgeStyler(variant: FortalBadgeVariant.surface),
        ),
        RemixBadge(
          label: 'Outline',
          style: fortalBadgeStyler(variant: FortalBadgeVariant.outline),
        ),
      ],
    );
  }
