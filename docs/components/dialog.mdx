...
<Info>
  See the [fortalDialogStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/dialog.dart) for all available options.
</Info>

## Show function
<CodeGroup title="showRemixDialog" defaultLanguage="dart">
{/* dart-excerpt: signature listing */}
```dart
