...
<Info>
  See the [FortalIconButtonStyles source code](https://github.com/btwld/remix/blob/main/lib/src/components/icon_button/fortal_icon_button_styles.dart) for all available options.
</Info>
