...
<Info>
  See the [fortalIconButtonStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/icon_button.dart) for all available options.
</Info>
