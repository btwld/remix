    ...
    return Wrap(
      ...
      children: [
        RemixIconButton(
          icon: Icons.add,
          onPressed: () {},
          style: fortalIconButtonStyler(variant: FortalIconButtonVariant.solid),
        ),
        RemixIconButton(
          icon: Icons.edit,
          onPressed: () {},
          style: fortalIconButtonStyler(variant: FortalIconButtonVariant.soft),
        ),
        RemixIconButton(
          icon: Icons.layers,
          onPressed: () {},
          style: fortalIconButtonStyler(variant: FortalIconButtonVariant.surface),
        ),
        RemixIconButton(
          icon: Icons.border_style,
          onPressed: () {},
          style: fortalIconButtonStyler(variant: FortalIconButtonVariant.outline),
        ),
        RemixIconButton(
          icon: Icons.delete,
          onPressed: () {},
          style: fortalIconButtonStyler(variant: FortalIconButtonVariant.ghost),
        ),
      ],
    );
  }
