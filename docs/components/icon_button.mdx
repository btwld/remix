    ...
    return Row(
      ...
      children: [
        RemixIconButton(
          icon: Icons.add,
          onPressed: () {},
          style: fortalIconButtonStyle(variant: FortalIconButtonVariant.solid),
        ),
        RemixIconButton(
          icon: Icons.edit,
          onPressed: () {},
          style: fortalIconButtonStyle(variant: FortalIconButtonVariant.soft),
        ),
        RemixIconButton(
          icon: Icons.delete,
          onPressed: () {},
          style: fortalIconButtonStyle(variant: FortalIconButtonVariant.ghost),
        ),
      ],
    );
  }
