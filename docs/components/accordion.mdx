...
<Info>
  See the [fortalAccordionStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/accordion.dart) for all available options.
</Info>
