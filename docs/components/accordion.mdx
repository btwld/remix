      ...
      child: Column(
        children: [
          RemixAccordion(
            value: 'item1',
            title: 'First Item',
            style: FortalAccordionStyles.base(),
...
<Info>
  See the [FortalAccordionStyles source code](https://github.com/btwld/remix/blob/main/lib/src/components/accordion/fortal_accordion_styles.dart) for all available options.
</Info>
