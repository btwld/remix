...
<Info>
  See the [fortalCardStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/card.dart) for all available options.
</Info>
