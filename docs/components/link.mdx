...
<Info>
  See the [fortalLinkStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/link.dart) for all available options.
</Info>
