...
<Info>
  See the [fortalLinkStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/link.dart) for all available options.
</Info>
