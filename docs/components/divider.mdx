...
<Info>
  See the [fortalDividerStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/divider.dart) for all available options.
</Info>
