...
<Info>
  See the [fortalMenuStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/menu.dart) for all available options.
</Info>
