...
<Info>
  See the [fortalMenuStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/menu.dart) for all available options.
</Info>
