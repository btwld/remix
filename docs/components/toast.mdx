...
<Info>
  See the [fortalToastStyle source code](https://github.com/btwld/remix/blob/main/registry_source/lib/src/fortal/components/toast.dart) for all available options.
</Info>
