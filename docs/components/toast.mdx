...
<Info>
  See the [fortalToastStyle source code](https://github.com/conceptadev/remix/blob/main/registry_source/fortal/lib/src/components/toast.dart) for all available options.
</Info>
