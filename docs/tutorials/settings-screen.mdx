...
![Launchpad with the Vanilla preset and a cyan preview button](/assets/remix-cli-tutorial/default-finished.jpg)
...
<Accordions>
<Accordion title="Complete Vanilla lib/main.dart">
...
Do not switch the Vanilla project's preset. From its directory, create a
second application:
...
<Accordions>
<Accordion title="Vanilla workflow tests">
...
- **No `primary` constructor:** use the Vanilla sample with `vanilla`, or the `solid` constructor with `fortal`.
