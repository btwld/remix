# Component Audit Checklist: Remix0
...
### Component Files
- lib/src/components/0/0.dart
- lib/src/components/0/0_widget.dart  
- lib/src/components/0/0_style.dart
- lib/src/components/0/0_spec.dart

### Known Issues
Has semantics implementation
...
### Naming Conventions
- [ ] Component name follows `Remix0` pattern
- [ ] Widget class is `0Widget`
- [ ] Style class is `0Style`
- [ ] Spec class is `0Spec`
