...
### Naming Conventions
- [ ] Main widget class follows `Remix[Name]` pattern
- [ ] Style class follows `Remix[Name]Style` pattern
- [ ] Spec class follows `[Name]Spec` pattern
- [ ] File structure follows `[name]_widget.dart`, `[name]_style.dart`, `[name]_spec.dart` pattern
