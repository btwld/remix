...
Remix is a Flutter component library built on [Mix](https://github.com/btwld/mix),
which defines styling, and [Naked UI](https://github.com/btwld/naked_ui),
...
It covers the small `vanilla` preset and the separate `fortal` preset.
...
to compare it with the Vanilla preset. Keep the two presets in separate
...
- [Fortal dashboard](https://btwld.github.io/remix/dashboard/): an application with layouts, data, and theme controls.
- [Component catalog](https://btwld.github.io/remix/catalog/): components, variants, and interaction states.
