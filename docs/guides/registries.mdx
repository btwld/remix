...
`--ref registry-stable` moves to the newest promoted commit. `--ref <sha>`
pins that commit.

```shell
dart run remix_cli:remix registry update @remix --ref registry-stable
dart run remix_cli:remix registry update @remix --ref <sha>
