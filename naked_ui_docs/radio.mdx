...
- Legacy interaction callbacks: `onPressChange`/`onHoverChange`/`onFocusChange` (prefer `builder` pattern)
...
- Keep your focus/hover styles visible using `state.isFocused` / `isHovered`
