...
// This is the same test from integration_test but runs as a widget test
// No ChromeDriver or device needed!
...
void main() {
  // No need for IntegrationTestWidgetsFlutterBinding here!
  // These run as regular widget tests

  group('Button Integration Tests (as Widget Tests)', () {
    ...
    testWidgets('Button state transitions work correctly', (WidgetTester tester) async {
      ...
      await tester.tap(find.byKey(const ValueKey('state_button')));
      await tester.pump();
      expect(tapCount, equals(1)); // Should still be 1 since button is disabled
    });
