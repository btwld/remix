        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              'Base Style',
              [
                _buildButtonRow('Default Button', RadixButtonStyles.solid()),
              ],
            ),
      ...
      Wrap(
        ...
        children: [
          RemixButton(
            ...
            style: RadixButtonStyles.solid().padding(EdgeInsetsGeometryMix.all(8.0)),
          ),
          RemixButton(
            label: 'Medium',
            icon: Icons.circle,
            onPressed: () => debugPrint('Medium button pressed'),
            style: RadixButtonStyles.solid().padding(EdgeInsetsGeometryMix.all(12.0)),
          ),
          RemixButton(
            label: 'Large',
            icon: Icons.circle,
            onPressed: () => debugPrint('Large button pressed'),
            style: RadixButtonStyles.solid().padding(EdgeInsetsGeometryMix.all(16.0)),
          ),
        ],
      ),
    ],
