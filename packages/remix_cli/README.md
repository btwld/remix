...
runtime package. Its terminal executable is named `remix`. After the first
public beta is published, activate the CLI globally and ensure Dart's
pub-cache `bin` directory is on your `PATH`:
