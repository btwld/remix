...
/// All available accent colors in the Radix UI color system.
///
/// Each accent color represents a complete 12-step color scale designed for
/// optimal contrast, accessibility, and aesthetic harmony. The colors are
/// carefully crafted to work well together and provide semantic meaning
/// across light and dark themes.
///
/// **Color Categories:**
/// - **Primary**: blue, indigo, violet, purple, plum, pink
/// - **Warm**: red, crimson, ruby, tomato, orange, amber, yellow
/// - **Cool**: sky, cyan, teal, mint, jade, green, grass, lime
/// - **Neutral**: gray, mauve, slate, sage, olive, sand, bronze, brown, gold
///
/// Example usage:
/// ```dart
/// createRadixScope(
///   accent: RadixAccentColor.blue,  // Professional blue
///   child: MyApp(),
/// )
/// ```
...
/// Available gray color variants for neutral interface elements.
///
/// Each gray variant provides a complete 12-step scale with subtle color
/// undertones that create different moods and work harmoniously with
/// different accent colors.
///
/// **Gray Variants:**
/// - **gray**: Pure achromatic gray, works with any accent color
/// - **mauve**: Purple-tinted gray, pairs well with purple accents
/// - **slate**: Blue-tinted gray, pairs well with blue/cyan accents
/// - **sage**: Green-tinted gray, pairs well with green accents
/// - **olive**: Yellow-green tinted, pairs well with warm accents
/// - **sand**: Yellow-tinted gray, pairs well with orange/amber accents
///
/// The undertone creates subtle color harmony with the chosen accent color
/// while maintaining excellent readability for text and interface elements.
///
/// Example:
/// ```dart
/// createRadixScope(
///   accent: RadixAccentColor.blue,
///   gray: RadixGrayColor.slate,  // Blue-tinted gray
///   child: MyApp(),
/// )
/// ```
enum RadixGrayColor {
...
/// Core theme configuration that defines the color palette and appearance mode.
///
/// This lightweight configuration object specifies which accent color,
/// gray variant, and brightness mode to use for the Radix design system.
/// It's used internally by the token resolution system to compute all
/// the semantic colors and functional roles.
///
/// The theme determines:
/// - Which 12-step accent color scale to use for interactive elements
/// - Which gray variant provides the neutral color foundation
/// - Whether to use light or dark mode algorithms for color computation
///
/// Example:
/// ```dart
...
/// Represents a complete 12-step color scale with solid and alpha variants.
///
/// This is the core data structure of the Radix color system. Each scale
/// contains both solid colors and their alpha (translucent) counterparts,
/// providing maximum flexibility for UI design.
///
/// **12-Step Semantic Structure:**
/// ```
/// Steps 1-2:  App backgrounds (subtle → more visible)
/// Steps 3-5:  Component backgrounds (rest → hover → active)
/// Steps 6-8:  Borders (subtle → standard → emphasis)
/// Steps 9-10: Solid backgrounds (default → hover)
/// Steps 11-12: Text colors (low contrast → high contrast)
/// ```
///
/// **Color Science:**
/// All steps are perceptually uniform and maintain consistent contrast ratios
/// for accessibility. The alpha variants preserve the original color's
/// saturation when composited, unlike naive opacity adjustments.
///
/// Example usage:
/// ```dart
/// final accent = RadixColorScale(solidSwatch, alphaSwatch);
/// 
/// // Semantic access
/// final buttonColor = accent.solidBackground;      // Step 9
/// final buttonHover = accent.solidBackgroundHover; // Step 10
/// final textColor = accent.highContrastText;       // Step 12
/// 
/// // Direct step access
/// final step5 = accent.step(5);
/// final alphaStep3 = accent.alphaStep(3);
/// ```
